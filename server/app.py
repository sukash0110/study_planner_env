        ...
        <html lang="en">
          ...
          <body>
            <div class="topbar">
              <div class="brand">
                ...
                <div>
                  ...
                  <div class="brand-copy">Running on AuraUI 1.1.1 with harder deadline-aware planning, stronger grading, and stability improvements.</div>
                </div>
              </div>
              <div class="actions">
            ...
            <div class="frame-wrap">
              <iframe src="/ui" title="EduDynamics on AuraUI 1.1.1"></iframe>
            </div>
          </body>
        </html>
        """
